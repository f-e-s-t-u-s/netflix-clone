...
const handlesubmit=(e)=>{
  ...
  if(password!==''){
    ...
    setpreloader(true)
    axios.post('http://localhost:8000/api/register',values).then(data=>{
      setpreloader(false)
  ...
  return (
    <main>
      ...
      <div className="reg-child">
        {preloader===true && <div className="preloader">
        ...
        <form  className="form" onSubmit={handlesubmit}>
          <div className="reg">
            ...
            <input
              ...
              value={email}
            />
            <input className="input1" type="password" name="password" id="" placeholder="add a password" />
